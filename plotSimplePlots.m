function plotSimplePlots(glob, depos)
        ...
        lobeOrFlowColourCoding = 1; % Control colour coding, either by individual flow (0) or by lobe (1)
        transparency = 0.75; % Control transparency of flow areas in 3D plot, from totally opaque (0) to totally transparent (1)
        xCross = 240; % Position of the dip-oriented section on the x-axis
        yCross = 100;  % Position of the strike-oriented section on the y-axis
