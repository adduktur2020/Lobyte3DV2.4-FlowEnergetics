function plotVerticalSectionAndChronostrats(glob, depos, x, y, modelName)
...
%     lobeShiftScaleFactor = lobeShiftPlotWidth / max(glob.centroidSeperation);
    ...
    sortCentroidSeperations = sort(glob.centroidSeperation, 'descend');
    centroidSeparationCutoff = sortCentroidSeperations(25);
...
%     xco = lobeShiftPlotWidthStartXco + (lobeShiftScaleFactor * glob.centroidSeperation(t));
